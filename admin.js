(async () => {
  ...
  const adminModules=["./admin-render.js?v=20260923-birgit-final2-adminflat2","./admin-actions.js?v=20260925-communications5","./admin-calendar-views.js?v=20260923-birgit-final2-adminflat2","./admin-calendar-workspace.js?v=20260923-birgit-final2-adminflat2","./admin-customer-detail.js?v=20260923-birgit-final2-adminflat2","./admin-payments.js?v=20260923-birgit-final2-adminflat2","./admin-appointment-detail.js?v=20260925-communications5","./admin-services-manager.js?v=20260923-birgit-final2-adminflat2","./admin-customer-numbers.js?v=20260923-birgit-final2-adminflat2","./admin-pickup-shop.js?v=20260923-birgit-final2-adminflat2","./admin-demo-profiles.js?v=20260923-birgit-final2-adminflat2","./admin-whatsapp.js?v=20260925-communications5","./admin-recurring-blocks.js?v=20260923-birgit-final2-adminflat2","./admin-communications.js?v=20260925-communications5","./admin-workflow.js?v=20260925-workfile1","./admin-completion.js?v=20260925-communications5","./admin-media.js?v=20260925-demoapp2"];
  Promise.all(adminModules.map(url=>importWithRetry(url))).then(()=>{api.initDemoProfiles?.();api.initCustomerNumbers?.();api.bindActions();api.initServiceManager?.();api.initCalendarViews();api.initRecurringBlocks?.();api.initPickupShop?.();api.initCommunication?.();api.initWorkflowHub?.();api.renderAll();api.refreshPaymentUI?.();api.initWhatsApp?.();api.initCompletion?.();api.initCustomerMedia?.();api.bindCustomerDetailRows?.();window.SmileShineDemoApp?.init?.(api);api.showView(location.hash.replace('#','')||'dashboard');api.ready=true;document.documentElement.dataset.adminReady='true'}).catch(error=>{api.initError=String(error?.stack||error||'Unbekannter Initialisierungsfehler');console.error(error);api.toast('Die Studio-Vorschau konnte nicht vollständig geladen werden.')});
})();