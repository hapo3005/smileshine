(() => {
  ...
  window.SSAdmin=api;
  Promise.all([import('./admin-render.js?v=20260923-birgit-final2'),import('./admin-actions.js?v=20260923-birgit-final2'),import('./admin-calendar-views.js?v=20260923-birgit-final2'),import('./admin-calendar-workspace.js?v=20260923-birgit-final2'),import('./admin-customer-detail.js?v=20260923-birgit-final2'),import('./admin-payments.js?v=20260923-birgit-final2'),import('./admin-appointment-detail.js?v=20260923-birgit-final2'),import('./admin-services-manager.js?v=20260923-birgit-final2-svc2'),import('./admin-customer-numbers.js?v=20260923-birgit-final2'),import('./admin-pickup-shop.js?v=20260923-birgit-final2')]).then(()=>{api.initCustomerNumbers?.();api.bindActions();api.initServiceManager?.();api.initCalendarViews();api.initPickupShop?.();api.renderAll();api.refreshPaymentUI?.();api.bindCustomerDetailRows?.();api.showView(location.hash.replace('#','')||'dashboard');api.ready=true;document.documentElement.dataset.adminReady='true'}).catch(error=>{api.initError=String(error?.stack||error||'Unbekannter Initialisierungsfehler');console.error(error);api.toast('Die Studio-Vorschau konnte nicht vollständig geladen werden.')});
})();