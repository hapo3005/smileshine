(async () => {
  ...
  function seed(){
    ...
    return {version:1,slotInterval:30,buffer:15,
      services:[
        {id:'brows',name:'Augenbrauen',description:'Form, Balance und Ausdruck mit natürlicher Wirkung.',duration:90,price:299,deposit:50,active:true},
        {id:'eyes',name:'Lid & Wimpernkranz',description:'Dezente Betonung für einen klaren und wachen Blick.',duration:75,price:249,deposit:50,active:true},
        {id:'lips',name:'Lippen',description:'Kontur, Farbe und Frische mit natürlichem Ergebnis.',duration:120,price:349,deposit:75,active:true},
  ...
  const adminModules=["./admin-render.js?v=20260925-services7","./admin-actions.js?v=20260925-services7","./admin-calendar-views.js?v=20260923-birgit-final2-adminflat2","./admin-calendar-workspace.js?v=20260923-birgit-final2-adminflat2","./admin-customer-detail.js?v=20260923-birgit-final2-adminflat2","./admin-payments.js?v=20260923-birgit-final2-adminflat2","./admin-appointment-detail.js?v=20260925-communications5","./admin-services-manager.js?v=20260925-services8","./admin-customer-numbers.js?v=20260923-birgit-final2-adminflat2","./admin-pickup-shop.js?v=20260923-birgit-final2-adminflat2","./admin-demo-profiles.js?v=20260925-services8","./admin-whatsapp.js?v=20260925-communications5","./admin-recurring-blocks.js?v=20260923-birgit-final2-adminflat2","./admin-communications.js?v=20260925-communications5","./admin-workflow.js?v=20260925-services7","./admin-completion.js?v=20260925-workday3","./admin-media.js?v=20260925-demoapp2"];
  try{
    for(const url of adminModules)await importWithRetry(url);
    api.initDemoProfiles?.();api.initCustomerNumbers?.();api.bindActions();api.initServiceManager?.();api.initCalendarViews();api.initRecurringBlocks?.();api.initPickupShop?.();api.initCommunication?.();api.initWorkflowHub?.();api.renderAll();api.refreshPaymentUI?.();api.initWhatsApp?.();api.initCompletion?.();api.initCustomerMedia?.();api.bindCustomerDetailRows?.();await window.SmileShineDemoApp?.init?.(api);api.showView(location.hash.replace('#','')||'dashboard');api.ready=true;document.documentElement.dataset.adminReady='true';
  }catch(error){
