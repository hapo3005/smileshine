(() => {
  ...
  function injectStyles(){
    ...
    const style=document.createElement('style');style.id='pickupShopStyles';style.textContent=`
      ...
      .pickup-payment-options{display:grid;grid-template-columns:1fr 1fr;gap:8px}.pickup-payment-options.pickup-payment-single{grid-template-columns:1fr}.pickup-payment-option{border:1px solid var(--line);border-radius:11px;background:#fff;padding:10px;text-align:left;cursor:pointer;color:inherit}.pickup-payment-option strong{display:block;font-size:9px}.pickup-payment-option small{display:block;font-size:7px;color:var(--muted);margin-top:3px;line-height:1.4}.pickup-payment-option.active{border-color:#c99189;background:#fff7f4;box-shadow:0 0 0 2px rgba(201,145,137,.09)}
