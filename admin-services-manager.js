(() => {
  ...
  function ensureStyles(){if(document.querySelector('link[data-service-manager-style]'))return;const l=document.createElement('link');l.rel='stylesheet';l.href='admin-services-manager.css?v=20260925-services7';l.dataset.serviceManagerStyle='true';document.head.appendChild(l)}
