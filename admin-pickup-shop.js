(() => {
  ...
  function render(){
    ...
    root.innerHTML=visible.length?visible.map(orderCard).join(''):'<div class="pickup-admin-empty"><strong>Keine offenen Abholaufträge.</strong><span>Neue Abholbestellungen aus der Vorschau erscheinen hier auf diesem Gerät.</span></div>';
